...
func TestReduce(t *testing.T) {
	tests := map[string]struct {
		...
		"X.X-documented_use-case": {
			...
			expectedMat: [][]float64{
				{1, 0, 0, 0, 0, 0, 0, -.3333, -42.3333},
				{0, 1, 0, 0, 0, 0, 0, 0.6667, 108.6667},
				{0, 0, 1, 0, 0, 0, 0, 0, 5},
				{0, 0, 0, 1, 0, 0, 0, -0.6667, -108.6667},
				{0, 0, 0, 0, 1, 0, 0, 1.3333, 224.3333},
				{0, 0, 0, 0, 0, 1, 0, -0.3333, -53.3333},
				{0, 0, 0, 0, 0, 0, 1, 0.6667, 124.6667},
			},
			expectedSolution: []float64{12, 0, 5, 0, 7, 1, 16, 163},
		},
		"machine-8-documented_use-case": {
			matrixValues: [][]float64{
				{0, 0, 0, 1, 1, 1, 1, 1, 0, 53},
				{1, 0, 1, 1, 1, 0, 1, 0, 1, 69},
				{0, 1, 0, 1, 0, 1, 1, 0, 1, 38},
				{1, 0, 0, 0, 0, 1, 0, 1, 1, 16},
				{0, 0, 1, 1, 0, 0, 1, 1, 0, 52},
				{1, 0, 1, 0, 1, 1, 1, 1, 1, 69},
				{0, 1, 0, 1, 0, 1, 0, 0, 1, 25},
			},
			expectedMat: [][]float64{
				{1, 0, 0, 0, 0, 0, 0, 0, -.3333, -42.3333},
				{0, 1, 0, 0, 0, 0, 0, 0, 0.6667, 108.6667},
				{0, 0, 1, 0, 0, 0, 0, 0, 0, 5},
				{0, 0, 0, 1, 0, 0, 0, 0, -0.6667, -108.6667},
				{0, 0, 0, 0, 1, 0, 0, 0, 1.3333, 224.3333},
				{0, 0, 0, 0, 0, 1, 0, 0, -0.3333, -53.3333},
				{0, 0, 0, 0, 0, 0, 1, 0, 0.6667, 124.6667},
			},
			expectedSolution: []float64{12, 0, 5, 0, 7, 1, 16, 163, 0},
		},
	}
